...
export default function ResetPasswordModal({
  driverId, driverName, onClose, onReset,
}: {
  driverId: string;
  driverName: string;
  onClose: () => void;
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/operator-admin/reset-driver-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ idToken, driverId, newPassword }),
      });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "0.8rem", color: "#6b8f7a", margin: 0 }}>{driverName}</p>
