...
export const MOCK_PICKUPS = [
  ...
  },
  {
    ...
    wasteType: "Wood",
    status: "IN TRANSIT",
    location: "Elewuro, Akobo, Ibadan",
    dates: "Feb 2 – Feb 4, 2026",
    weight: "12 Tons",
    note: "Do a great job",
  },
  {
    ...
    wasteType: "Mixed",
    status: "IN TRANSIT",
    location: "854 Bristol Road",
    dates: "Jan 30 – Jan 30, 2026",
    weight: "8 Tonnes",
    note: "Ring Josh on arrival. Thanks",
  },
  {
    id: "WF-0037",
    title: "Studs",
    wasteType: "Metal",
    status: "IN TRANSIT",
    location: "Broad Road Birmingham",
  ...
  {
    id: "WF-0036",
    title: "Concrete Debris for My building",
    wasteType: "Mixed",
    status: "SCHEDULED",
    location: "Lagos, NGA",
...
function PickupCard({ item, onViewDetails }) {
  return (
    <div className="wf-pickup-card" style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <MetaRow icon={
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: 13, height: 13 }}>
            <path d="M12 2a5 5 0 1 0 0 10A5 5 0 0 0 12 2zm0 0v10M7 7h10"/>
          </svg>
        } text={item.weight} />
        {item.note && (
          <MetaRow icon={
...
export default function MyPickupsPage() {
  ...
  const filtered = MOCK_PICKUPS.filter((item) => {
  ...
  const inTransitCount = MOCK_PICKUPS.filter(p => p.status === "IN TRANSIT").length;
  const arrivingCount  = MOCK_PICKUPS.filter(p => p.status === "ARRIVING").length;
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 1100px) {
          .wf-pickup-grid { grid-template-columns: repeat(2, 1fr); }
        }
        ...
        @media (max-width: 768px) {
          ...
          .wf-pickup-grid { grid-template-columns: 1fr; }
        }
            ...
            <div className="wf-stats-row">
              <div className="wf-stat-chip">
                ...
                <span style={{ fontSize: "0.8rem", fontWeight: 700, color: "#1a4d2e", fontFamily: "'Quicksand', sans-serif" }}>
                  {MOCK_PICKUPS.length} active pickups
                </span>
              </div>
              {inTransitCount > 0 && (
                <div className="wf-stat-chip">
