          ...
          <div className="wf-modal-body">
            ...
            <div style={{ paddingTop: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {[
                  { label: "Request submitted",  sub: "Operator raised a pickup request",   done: true  },
                  { label: "Request accepted",   sub: "Contractor confirmed the job",        done: true  },
                  { label: "In transit",         sub: "Contractor collected the waste",      done: true  },
