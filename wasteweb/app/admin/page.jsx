      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 600px) {
          .wf-content { padding: 18px; gap: 18px; }
          .wf-topbar { padding: 0 18px; }
        }
      `}</style>

      <div className="wf-admin-root">
        <Sidebar adminEmail="admin@wasteflow.org" onSignOut={() => { window.location.href = "/login"; }} />

        <main className="wf-admin-main">

          {/* Topbar */}
          <div className="wf-topbar">
            <span className="wf-topbar-title">Admin Dashboard</span>
